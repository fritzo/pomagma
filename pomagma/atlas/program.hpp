...
#define POMAGMA_OP_CODES(DO)                                                   \
    ...
    DO(INFER_NULLARY_INJECTIVE, ({NULLARY_FUNCTION, INJECTIVE_FUNCTION, OB}))  \
    DO(INFER_NULLARY_BINARY, ({NULLARY_FUNCTION, BINARY_FUNCTION, OB, OB}))    \
...
static constexpr size_t g_op_code_count = 0
#define DO(X, Y) +1
    POMAGMA_OP_CODES(DO)
#undef DO
    ;
...
template <class Ob, class SetPtr>
inline Program ProgramParser::load_continuation(Context_<Ob, SetPtr>* context,
