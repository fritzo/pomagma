...
void declare_signature() { POMAGMA_INFO("declare_signature()"); }

void insert_nullary_functions() { POMAGMA_INFO("insert_nullary_functions()"); }
...
void validate_all() { POMAGMA_INFO("validate_all()"); }
