...
- [ ] Add IF_GLOBAL opcode to [`pomagma/atlas/program.hpp`](../pomagma/atlas/program.hpp) and implement VM handler in [`pomagma/atlas/vm_impl.hpp`](../pomagma/atlas/vm_impl.hpp)
- [ ] Extend VirtualMachine class in [`pomagma/atlas/vm.hpp`](../pomagma/atlas/vm.hpp) with global configuration state management
